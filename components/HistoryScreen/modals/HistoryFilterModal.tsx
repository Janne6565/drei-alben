import { toggleShowAllAlbums, setFilteredCharacters } from "@/features/historySettings/historySettings.slice";
...
export function HistoryFilterModal() {
  ...
  return (
    <BottomModal ref={filterModalRef} height={"50%"} onDismiss={onDismiss} asChild>
      <BottomSheetView
